...
export default function TaskColumn({ status, tasks, projectName, onMove, onEdit, onDelete, onAdd }: Props) {
  return (
    <div className="flex flex-col bg-white/60 backdrop-blur-xl border border-gray-200/40 rounded-2xl p-3 min-w-[78vw] md:min-w-0 flex-shrink-0 md:flex-1 snap-center shadow-sm">
